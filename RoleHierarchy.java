                ...
                if(p.roleName.equals(delete)){
                    ...
                    for(int i=0;i<p.child.size();i++)
                    {
                        if(p.child.get(i).roleName.equals(roleToTransfer))
                        {
                            ...
                            p.userName.addAll(p.child.get(i).userName);
                            p.child.remove(i);
            ...
            while (n > 0)
            {
                ...
                for(int j=0; j < p.child.size(); j++){
                    for(int k=0; k < p.child.get(j).userName.size(); k++){
                        if(p.child.get(j).userName.get(k)!=null)
    ...
    static int commonBoss(Node root){
        ...
        while(!q.isEmpty()){
            ...
            while(n>0){
                ...
                q.remove();
                for(int i=0;i<p.userName.size();i++){
                    if(p.userName.get(i).equals(user1)){
                        count++;
                    }
                    else if(p.userName.get(i).equals(user2)){
                        count++;
                    }
                }
                for(int j=0; j<p.child.size(); j++){
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            case 10:
                ...
                if(number == 2){
                    for(int i=0;i<root.userName.size();i++)
                        System.out.println(root.userName.get(i));
                }
                else{
                ...
                break;
            default:
                System.out.println("Enter an operation between 1 and 10");
            }
